...
const bingFunction = () => {
  ...
  if (error) {
    ...
    return (
      <div>
        <Nav updateUser={props.updateUser} />
        <img src = {require("../img/state-5.jpg")} className={classes.image} ></img>
        <Location
          name={place.name}
          np
  ...
  <Button variant="contained" style={{ width: "20%", marginLeft: '40%', marginRight: '40%', marginTop: '10px', marginBottom: '10px', background: 'linear-gradient(45deg, #FE6B8B 30%, #FF8E53 90%)', fontFamily: 'serif'}} disableElevation type="submit" >
                New Search
              </Button>
            </form>
          </Grid>
    ...
    return (
      <div>
        <Nav updateUser={props.updateUser} />
        <img src = {require("../img/state-4.jpg")} className={classes.image} ></img>
...
<form>
            <Button variant="contained" style={{ width: "20%", marginLeft: '40%', marginRight: '40%', marginTop: '10px', marginBottom: '10px', background: 'linear-gradient(45deg, #FE6B8B 30%, #FF8E53 90%)', fontFamily: 'serif', color: 'white'}} disableElevation type="submit" >
                New Search
              </Button>
            </form>
          </Grid>
    ...
    return (
      <div>
        ...
        <Grid item container style={{ position: "center" }}>
          <Grid item xs={12} className={classes.cityRow}>
          <form>
<Typography style={{backgroundColor: "white", color: '#060063', width: "100%", fontFamily: 'serif', fontSize: 30, textAlign: 'center'}}> Please choose if you would like to build a custom trip, or  plan a day trip! 
</Typography>
{/* <Typography style={{backgroundColor: "#8CBF1C", color: '#060063', width: "100%", fontFamily: 'serif', fontSize: 30, textPosition: 'center'}}> You can begin a new search by clicking the 'new search' button!
            ...
            <form style={{ postion: 'center' }}>
              <Button variant="contained"  style={{ width: "20%", marginLeft: '40%', marginRight: '40%', marginTop: '10px', marginBottom: '10px', background: 'linear-gradient(45deg, #293B5F 30%, #47597E 90%)', fontFamily: 'serif', color: 'white'}} disableElevation type="submit" >New Search</Button>
            </form>
          </Grid>
        </Grid>
  ...
  // STATE TWO!!! STATE TWO!!! STATE TWO!!! STATE TWO!!! STATE TWO!!! STATE TWO!!! STATE TWO!!! STATE TWO!!! STATE TWO!!! STATE TWO!!!
    ...
    return (
      <div>
        <Nav updateUser={props.updateUser} />
        <Grid item container>
          <img src = {require("../img/state-2.jpg")} className={classes.image} ></img>
        </Grid>
        ...
        <Grid item container>
          <Grid item xs={12} className={classes.cityRow}>
            ...
            <form>
              ...
              <Button variant="contained" style={{ width: "20%", marginLeft: '40%', marginRight: '40%', marginTop: '10px', marginBottom: '10px',  background: 'linear-gradient(45deg, #293B5F 30%, #47597E 90%)', fontFamily: 'serif' }} disableElevation type="submit" onClick={handleSubmit}>
                Search
              </Button>
        ...
        <form>
<Typography style={{backgroundColor: 'linear-gradient(45deg, #293B5F 30%, #47597E 90%)', color: '#060063', width: "100%", fontFamily: 'serif', fontSize: 40, textAlign: 'center' }}>  Which {searchTerm} you would like to go to?
</Typography>
</form>
  ...
  // STATE ONE!! STATE ONE!! STATE ONE!! STATE ONE!! STATE ONE!! STATE ONE!! STATE ONE!! STATE ONE!! STATE ONE!! STATE ONE!! STATE ONE!!
    ...
    return (
      <div style={{ backgroundColor: "blue" }}>
        <Nav updateUser={props.updateUser} />
        <Grid item container> 
          <img src={require("../img/bg1.jpg")} className={classes.image} ></img>
        </Grid>
        {/* buttons container */}
        <Grid item container>

      
<Typography style={{background:"linear-gradient(45deg, #293B5F 30%, #293B5F 90%)", color: 'white', width: "100%", fontFamily: 'Roboto', fontSize: 45, textAlign: 'center' , border: 0,
    borderRadius: 3,
          ...
          <Grid item xs={12} className={classes.cityRow}>
            <form style={{ postion: "center" }}>
              <input
                ...
                onChange={handleInputChange}
              ></input>
              <Button variant="contained" style={{ width: "20%", marginLeft: '40%', marginRight: '40%', marginTop: '10px', marginBottom: '20px', background: 'linear-gradient(45deg, #293B5F 30%, #47597E 90%)', fontFamily: 'serif' }} disableElevation type="submit" onClick={handleSubmit}>
                Search
              </Button>
            </form>
